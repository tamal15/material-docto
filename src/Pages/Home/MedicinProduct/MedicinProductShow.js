...
const MedicinShowProduct = () => {
    ...
    const fetchData = () => {
      fetch('http://localhost:5000/adminMedicin')
      .then(res => res.json())
      .then(data => {
          setQuestions(data.allQuestions)
          setModel(data.allQuestions)
              ...
              >
               ...
               <Box sx={{ display: 'flex', justifyContent: '', marginBottom:"" }}>
                  ...
                  <NavLink
                    ...
                    className="details-showss"
                    style={{ textDecoration: "none", marginRight: "4px" }}
                  >
                    <Button
                     className='btn-styless download-btnss details-showss downpart'
                     style={{padding:"5px"}}
                    size="small">
                      Details
                    </Button>
                  ...
                  <Button
                  className='btn-styless download-btnss'
                    size="small"
                    // sx={ButtonStyle}
...
export default MedicinShowProduct;