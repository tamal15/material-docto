           ...
           <Grid data-aos="fade-up" sx={{ py: 3 }} key={single._id} item xs={4} sm={4} md={3}>
             ...
             >
               ...
               <Box sx={{ display: 'flex', justifyContent: '', marginBottom:"" }}>
                 <NavLink
                   to={`/producDetails/${single._id}`}
                   style={{ textDecoration: "none",textAlign:"left" }}
                 >
                   <Button
                    className='btn-styles download-btns '
                 ...
                 {/* <NavLink
                   ...
                   className="details-shows"
                   style={{ textDecoration: "none", marginRight: "4px" }}
                 >
                   <Button
                    className='btn-styles download-btns details-shows ms-1'
                    style={{padding:"5px"}}
                   size="small">
                     Details
                   </Button>
                 ...
                 <Button
                 className='btn-styles download-btns ms-2'
                   size="small"
                   // sx={ButtonStyle}
                   style={{textAlign:"left"}}
...
export default ShowProductValue;