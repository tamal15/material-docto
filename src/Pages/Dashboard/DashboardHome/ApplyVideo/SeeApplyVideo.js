                  ...
                  <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                    <Box style={{textAlign:"left"}}>
                      ...
                      <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> userEmail : {single?.usersEmail}</h5>
                        
                      </Typography>
                      <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> Disease Name : {single?.Disease}</h5>
                        
                      </Typography>
                      <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> Phone Number : {single?.phone}</h5>
                      ...
                      <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> Join Code : {single?.code}</h5>
