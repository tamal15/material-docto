...
const ManageDataTable = (props) => {
    
    const { name, phone, status, hospitalName, _id ,index,email} = props.data
    ...
    const handleUpdate = (id) => {
        fetch(`http://localhost:5000/nurseStatusUpdate/${id}`, {
            method: "PUT",
        ...
        <>
            ...
            {/* <tbody key={_id}> */}
                 <tr role="row" style={{ question: "2px solid gray" }} >
                            ...
                            <td className='text-black'>{hospitalName}</td>
