...
const ManageOrganTable = (props) => {
    
    const { name, phone, status, organ, _id ,index,email} = props.data
    ...
    const handleUpdate = (id) => {
        fetch(`http://localhost:5000/organStatusUpdate/${id}`, {
            method: "PUT",
        ...
        <>
            ...
            {/* <tbody key={_id}> */}
                 <tr role="row" style={{ question: "2px solid gray" }} >
                            ...
                            <td className='text-black'>{organ}</td>
...
export default ManageOrganTable;