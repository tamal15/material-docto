...
const UserOrgan = (props) => {

    
    const { name, address, organ , userName, email, _id ,status,phone} = props.data
    ...
    return (
       <>
           <tr role="row" style={{ question: "2px solid gray",textAlign:"left" }} >
                            ...
                            <td style={{fontWeight:600,color:"black"}}>{organ}</td>
