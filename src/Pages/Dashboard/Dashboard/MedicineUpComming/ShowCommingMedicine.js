...
const ShowCommingMedicine = () => {
  ...
  //  ]
    return (
        <Container>
        <h2 style={{fontSize:"2.8em", fontWeight:"700", textAlign:"center", marginTop:"100px", color: "#7E2231"}}>UpComming Medicine</h2>
                  ...
                  <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                    <Box style={{textAlign:"left"}}>
                      ...
                      <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> price : TK.{single?.price}</h5>
...
export default ShowCommingMedicine;