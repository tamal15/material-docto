...
// import { CartContext } from "../../Contextcart/CartContext";
  ...
  const MedicineDetails = () => {
    ...
    useEffect(() => {
      fetch(`http://localhost:5000/productssDetails/${id}`)
        .then((res) => res.json())
    ...
    return (
      ...
      <Container>
          <Box sx={{ textAlign: "center", my: 5 }}>
            <Typography variant="h4" style={{fontWeight:"600", color:"black"}}>Product Name : {book?.productName
}</Typography>
            <Typography variant="h5" style={{fontWeight:"600",color:"black"}}> Price : {book?.ProductPrice
            ...
            <Grid item xs={4} sm={8} md={10}>
              ...
              >
                <Box>
                  ...
                  <span style={iconStyle}>
                    <BorderColorIcon color="primary" />
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> ProductPrice : {book?.ProductPrice
}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
