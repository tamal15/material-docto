...
import { CartContext } from "../../Contextcart/CartContext";
  ...
  const DetailsIcu = () => {
    ...
    useEffect(() => {
      fetch(`http://localhost:5000/IcuDetails/${id}`)
        .then((res) => res.json())
    ...
    return (
      ...
      <Container>
          <Box sx={{ textAlign: "center", my: 5 }}>
            <Typography variant="h4" style={{fontWeight:"600", color:"black"}}>HospitalName : {book?.HospitalName
}</Typography>
            <Typography variant="h5" style={{fontWeight:"600",color:"black"}}>  DriverName : {book?.DriverName
}</Typography>
          </Box>
              ...
              >
                <Box>
                  <span style={iconStyle}>
                    ...
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> AmbulanceNumber : {book?.AmbulanceNumber
}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    <BorderColorIcon color="primary" />
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> ProductPrice : {book?.ProductPrice}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    {" "}
                    ...
                    AmbulanceDescription : {book?.AmbulanceDescription}
                    </Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    ...
                    <PublishIcon color="primary" />
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600", textAlign:"left"}}>
                    HospitalDescription : {book?.HospitalDescription}
                    </Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
