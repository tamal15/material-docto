    ...
    return (
      ...
      <Container>
          <Box sx={{ textAlign: "center", my: 5 }}>
            <Typography variant="h4" style={{fontWeight:"600", color:"black"}}>Doctor Name : {book?.DoctorName
}</Typography>
            <Typography variant="h5" style={{fontWeight:"600",color:"black"}}> Doctor Expertist : {book?.specialist
}</Typography>
          </Box>
              ...
              >
                <Box>
                  <span style={iconStyle}>
                    ...
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> ProductName : {book?.DoctorName}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    <BorderColorIcon color="primary" />
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> Time : {book?.time}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    {" "}
