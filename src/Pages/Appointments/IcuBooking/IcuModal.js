...
const IcuModal = ({open,handleClose,booking,date}) => {
    const {name,time,price,HospitalName,AmbulanceNumber,DriverName }=booking
    const {user}=useAuth()
